...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    private static IReadOnlyDictionary<string, string> BuildChineseResources()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Section.SelectedProfile.Subtitle"] = "选择账号或 API，切换后继续原来的对话。",
            ...
            ["Status.SwitchedRestarted"] = "已切换到“{0}”，可以继续原有对话。",
            ["Status.SwitchedRestartFailed"] = "已切换到“{0}”；请手动打开 Codex 继续对话。",
            ["Status.AlreadyActive"] = "“{0}”当前已启用，无需切换。",
            ["Status.SwitchDetails"] = "同步了 {0} 条对话的路由。恢复点：{1}",
            ["Common.Details"] = "详细信息",
    ...
    private static IReadOnlyDictionary<string, string> BuildEnglishResources()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Section.SelectedProfile.Subtitle"] = "Choose an account or API and continue your conversations.",
            ...
            ["Status.SwitchedRestarted"] = "Switched to '{0}'. Continue your existing conversations.",
            ["Status.SwitchedRestartFailed"] = "Switched to '{0}'. Open Codex manually to continue.",
            ["Status.AlreadyActive"] = "'{0}' is already active. No switch needed.",
            ["Status.SwitchDetails"] = "Updated routing for {0} conversations. Recovery point: {1}",
            ["Common.Details"] = "Details",
