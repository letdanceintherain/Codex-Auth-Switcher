...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    private static IReadOnlyDictionary<string, string> BuildChineseResources()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Section.ThreadLibraryValue"] = "保留聊天内容与对话 ID；备份后同步模型商标记。",
            ...
            ["Dialog.ApiEditor.UseOpenAiThreadView.Checkbox"] = "切换时自动同步历史对话的模型商标记，并保留聊天内容。上方填写的模型商名称会直接生效。",
    ...
    private static IReadOnlyDictionary<string, string> BuildEnglishResources()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Section.ThreadLibraryValue"] = "Messages and thread IDs are preserved; provider metadata is backed up and synchronized.",
            ...
            ["Dialog.ApiEditor.UseOpenAiThreadView.Checkbox"] = "Switching automatically synchronizes conversation provider metadata while preserving messages. The provider name you enter is used directly.",
